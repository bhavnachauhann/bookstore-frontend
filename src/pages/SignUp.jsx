...
const SignUp = () => {
    const [values, setValues] = useState({
        ...
        email: "",
        password: "",
        address: "", // Corrected the spelling
    });

    const navigate = useNavigate();

    const change = (e) => {
        const { name, value } = e.target; // Corrected to 'value'
        setValues({ ...values, [name]: value }); // Corrected to 'value'
    };
            ...
            <div className='bg-zinc-800 rounded-lg px-8 py-5 w-full md:w-3/6 lg:w-2/6'>
                ...
                <div className='mt-4'>
                    <button
                        ...
                        onClick={submit}
                        type='button' // Ensuring it's a button, not a form submit
                    >
                        Sign Up
                    </button>
                </div>
                <p className='flex mt-4 items-center justify-center text-zinc-200 font-semibold'> Already have an account? &nbsp;
